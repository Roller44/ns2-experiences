...
#设置地一个分组的 CIR 为 1500000 bps，CBR 为 2000 bps，EBS 为 3000 B
#设置第二个分组的 CIR 为 1000000 bps，CBR 为 1000 bps，EBS 为 2000 B
...
#设置从 s1 到 dest 为第一分组，采用 SRTCM，并把符合标准的封包标成绿色
$qE1C addPolicyEntry [$s1 id] [$dest id] srTCM 10 $cir0 $cbs0 $ebs0
#设置从 s2 到 dest 为第二分组，采用 SRTCM，并把符合标准的封包标成绿色
