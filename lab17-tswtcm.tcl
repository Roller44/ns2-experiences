...
#设置 TSWTCM 的参数，在 NS2 中 TSWTCM 名称是 TSW3CM，设置地一个分组的 CIR 为 1500000 bps，PIR 为 3000000 bps，设置第二
#个分组的 CIR 为 1000000 bps，PIR 为 2000000 bps，设置地一个分组的 CBR 的传送速率为 4000000 bps，第二组的为 4000000bps
set cir0  1500000
set pir0  3000000
set rate0 4000000
set cir1  1000000
...
#设置从 s1 到 dest 为第一分组，采用 TSW3CM，并把符合标准的封包标成绿色
$qE1C addPolicyEntry [$s1 id] [$dest id] TSW3CM 10 $cir0 $pir0
#设置从 s2 到 dest 为第二分组，采用 TSW3CM，并把符合标准的封包标成绿色
